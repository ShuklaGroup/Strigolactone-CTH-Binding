...
Calc_N = natsorted(glob.glob('analysis/Other_Contacts/*229_to_278*'))
#Calc_N = natsorted(glob.glob('analysis/Helices/*n_terminus*'))
#Calc_N = natsorted(glob.glob('analysis/Helices/*c_terminus*'))
#Calc_N = natsorted(glob.glob('CoM_Distance_Sort.npy'))
#Calc_C = natsorted(glob.glob('analysis/Helical/*alpha*'))  #alpha or partial
#Calc_N = natsorted(glob.glob('analysis/Contacts_for_TICA/*246_to_217*'))
Calc_C = natsorted(glob.glob('analysis/Other_Contacts/*96_to_246*'))
#Calc_C = natsorted(glob.glob('Whole_Helix_vs_Protein_Angle_Sort.npy'))
#Calc_C = natsorted(glob.glob('Helix_Bending_Sort.npy'))
#Calc_C = natsorted(glob.glob('analysis/Helices/*distance*'))
#Calc_C = natsorted(glob.glob('analysis/Other_Contacts/*resid_266*'))
#Calc_N = natsorted(glob.glob('analysis/Pocket/*'))
...
round13n = natsorted(glob.glob('analysis/Helices/*round13*n_terminus*'))
round14n = natsorted(glob.glob('analysis/Helices/*round14*n_terminus*'))
round15n = natsorted(glob.glob('analysis/Helices/*round15*n_terminus*'))
