...
Vector1s = sorted(glob.glob('analysis/Displacement/*c_terminus*'))
Vector2s = sorted(glob.glob('analysis/Displacement/*middle*'))
...
np.save('Helix_Bending.npy', Helix_Bend_Angle)
