...
if __name__=="__main__": #'__main__' is the name of the python module. Name is set to the name of the script or module
    ...
    all_coords = np.load('Metric_Coords_Array_16.npy')
    ...
    for i in range(4):
        for j in range(16):
            ...
            free_energy(ax1_data, ax2_data, lims=(0, 6, -8, 8), max_energy=args.max_energy, label1=feature_label[j], label2='TICA_Col{0}'.format(i), savename='TICA_{0}_{1}.png'.format(i,j))
