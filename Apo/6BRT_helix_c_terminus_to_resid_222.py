...
for file in glob.glob('./stripped/*.strip.xtc'):
    ...
    d = md.compute_contacts(t,[[222,286]], scheme='ca')[0]     	# distance between the two residues on helix T3 and T1 respectively
    n_frames = t.n_frames
    ...
    np.save('./analysis/Helices/'+file.split('/')[-1]+'_c_terminus_helix_to_resid_222.npy',dis)
