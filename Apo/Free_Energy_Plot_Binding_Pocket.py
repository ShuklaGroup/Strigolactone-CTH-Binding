...
if __name__=="__main__": #'__main__' is the name of the python module. Name is set to the name of the script or module
    ...
    ax1_files = sorted(glob.glob('analysis/Pocket/*between*')) #distance between T1 and T2 binding pocket helices
    ax2_files = sorted(glob.glob('analysis/Helices/*_c_terminus*')) #distance between resid 97 and GR24 d-ring
