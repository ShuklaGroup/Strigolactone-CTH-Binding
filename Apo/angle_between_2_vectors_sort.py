...
Vector1s = natsorted(glob.glob('analysis/Displacement/*c_terminus*'))
Vector2s = natsorted(glob.glob('analysis/Displacement/*middle*'))
...
np.save('Helix_Bending_Sort.npy', Helix_Bend_Angle)
