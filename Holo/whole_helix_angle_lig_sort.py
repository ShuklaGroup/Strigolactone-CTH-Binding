...
Vector1s = natsorted(glob.glob('lig_analysis/Orientation/*whole_helix*'))
Vector2s = natsorted(glob.glob('lig_analysis/Orientation/*223*'))
...
np.save('Whole_Helix_vs_Protein_Angle_Lig_Sort.npy', Helix_Bend_Angle)
