...
print(all_coords)
np.save('Coords_for_Features_Lig.npy', all_coords)
...
#cluster_kmeans = pyemma.coordinates.cluster_kmeans(all_coords, k=350, stride=5)
...
#tica = pyemma.coordinates.tica(all_coords, dim=6, lag=1)
...
#pkl.dump(tica_output, open('TICA_Data_Lig.pkl', 'wb'))
