...
Vector1s = sorted(glob.glob('lig_analysis/Displacement/*c_terminus*'))
Vector2s = sorted(glob.glob('lig_analysis/Displacement/*middle*'))
...
np.save('Lig_Helix_Bending.npy', Helix_Bend_Angle)
