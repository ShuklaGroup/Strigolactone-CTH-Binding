            ...
            for i in range(6):
                if j >= i:
                    ...
                    free_energy(ax1_data, ax2_data, lims=(-8, 8, -8, 8), max_energy=args.max_energy, label1='TICA_Col{0}'.format(i), label2='TICA_Col{0}'.format(j), 
                        savename='TICA_{0}_{1}_r13_lig.png'.format(i,j))
    else:
        ...
        for j in range(6):
            for i in range (6):
                if j >= i:
                    ...
                    free_energy(ax1_data, ax2_data, lims=(-2, 4, -3, 3), max_energy=args.max_energy, label1='Holo TIC {0}'.format((j+1)), label2='Holo TIC {0}'.format((i+1)), 
                        savename='TICA_{0}_{1}_r13_lig.png'.format(i,j))
