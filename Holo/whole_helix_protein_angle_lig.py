...
Vector1s = sorted(glob.glob('lig_analysis/Orientation/*whole_helix*'))
Vector2s = sorted(glob.glob('lig_analysis/Orientation/*223*'))
...
np.save('Whole_Helix_vs_Protein_Angle_Lig.npy', Helix_Bend_Angle)
