...
for file in glob.glob('./lig_stripped/*.dcd'):
    ...
    d = md.compute_distances(t,[[2469,4423]]) #Ligand C4-Ser97 OG (D14)
    #d = md.compute_distances(t,[[1438,4156]]) #Ligand C4-Ser97 OG (D14)
    n_frames = t.n_frames
    ...
    np.save('./lig_analysis/THelices/'+file.split('/')[-1]+'_ftr-D-ring-T2-distance-bot.npy',dis)
