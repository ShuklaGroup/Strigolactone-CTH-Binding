...
Vector1s = natsorted(glob.glob('lig_analysis/Displacement/*c_terminus*'))
Vector2s = natsorted(glob.glob('lig_analysis/Displacement/*middle*'))
...
np.save('Helix_Bending_Lig_Sort.npy', Helix_Bend_Angle)
