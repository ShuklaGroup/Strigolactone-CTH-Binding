...
if __name__=="__main__": #'__main__' is the name of the python module. Name is set to the name of the script or module   
    ...
    datastuff = np.load('TICA_Data_Lig.npy')
    TICA = datastuff.T
    
    Calc_N = natsorted(glob.glob('lig_analysis/Helices/*n_terminus*'))
    ...
    #for next round of trajectories: pick 100 points in range of poorly-sampled TICA col 0 regions, seed with these